...
RSpec.describe 'Public Recipes List', type: :system do
  ...
  before(:each) do
    ...
    Recipe.create(user_id: @user3.id, name: 'Pasta', preparation_time: 30, cooking_time: 40,
                  description: 'White Sauce pasta', public: true)
    Recipe.create(user_id: @chris.id, name: 'Chicken Soup', preparation_time: 10, cooking_time: 45,
                  description: 'Sour Chicken Soup', public: true)
